...
export interface ApiBuildsummaryBuildsummary
  extends Struct.CollectionTypeSchema {
  collectionName: 'buildsummaries';
  info: {
    displayName: 'Buildsummary';
    pluralName: 'buildsummaries';
    singularName: 'buildsummary';
  };
  options: {
...
export interface ApiMediaPointMediaPoint extends Struct.CollectionTypeSchema {
  collectionName: 'media_points';
  info: {
    displayName: 'MediaPoint';
    pluralName: 'media-points';
    singularName: 'media-point';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMediapointMediapoint extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Mediapoint';
    pluralName: 'mediapoints';
    singularName: 'mediapoint';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Loudspeaker', 'Turntable', 'Amplifier']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::media-point.media-point': ApiMediaPointMediaPoint;
